 ...
 * ====================================
 * All user-facing text lives in this one file so it is easy to review,
 * refine and — later — translate. To add German (or any other language),
 * duplicate this structure into e.g. `site.de.ts` and select the content
 * object by locale; no component needs to change.
 *
...
export const siteContent = {
  ...
  home: {
    hero: {
      ...
      headline: "Taste, warmth and Alpine hospitality in the heart of Ramsau am Dachstein.",
      description:
    ...
    philosophy: {
      ...
      quote: "Hospitality means making people feel at home — even a thousand metres up.",
    },
    hours: {
  ...
  menu: {
    header: {
      eyebrow: "Our Menu",
      title: "Cooked with care, served with warmth",
      description:
  ...
  contact: {
    ...
    map: {
      ...
      loadNote: "The map is loaded from Google Maps only after you choose to view it.",
      iframeTitle: "Map showing the location of Zentrum Café Restaurant in Ramsau am Dachstein",
    },
    form: {
